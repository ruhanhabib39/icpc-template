...
\section{Debugging tricks}
	\begin{itemize}
		\item \verb@signal(SIGSEGV, @ \\ \verb@  [](int) { _Exit(0); });@ converts segfaults into Wrong Answers.
...
\section{Optimization tricks}
	...
	\subsection{Bit hacks}
		\begin{itemize}
			...
			\item \verb@for (int x = m; x; ) {@ \\\verb@  --x &= m; ... }@ loops over all subset masks of \texttt{m} (except \texttt{m} itself).
